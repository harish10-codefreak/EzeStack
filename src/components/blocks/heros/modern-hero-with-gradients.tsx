      ...
      <div className="relative z-20 mx-auto max-w-7xl px-4 py-20 md:px-8 lg:px-4">
        ...
        <div className="b relative my-12 overflow-hidden rounded-3xl bg-gray-50 py-10 md:py-40 dark:bg-black">
          ...
          <div className="relative z-20 flex flex-col items-center justify-center overflow-hidden rounded-3xl p-4 md:p-12">
            <Link
              href="#"
              className="flex items-center gap-1 rounded-full border border-[#404040] bg-gradient-to-b from-[#5B5B5D] to-[#262627] px-4 py-1 text-center text-sm text-white font-[var(--font-sans)]"
            >
              <span>Transforming Ideas into Digital Excellence</span>
              <ArrowRight className="h-4 w-4 text-white" />
            </Link>
            <h1 className="bg-gradient-to-b from-black to-neutral-600 bg-clip-text py-4 text-center text-2xl text-transparent md:text-4xl lg:text-7xl dark:from-white dark:to-[#999] font-[var(--font-heading)]">
              EzeStack
            </h1>
            <p className="mx-auto max-w-2xl py-4 text-center text-base text-neutral-600 md:text-lg dark:text-neutral-300 font-[var(--font-sans)]">
              We design and develop cutting-edge web applications, stunning landing pages, and comprehensive digital solutions. From AI integration to automation, we help businesses leap into the future.
            </p>
            <div className="flex flex-col items-center gap-4 py-4 sm:flex-row">
              <Link
                href="#"
                className="w-40 gap-1 rounded-full border border-transparent bg-[#10b981] px-4 py-2 text-center text-sm text-white font-[var(--font-sans)] transition-all hover:bg-[#059669]"
              >
                Start Your Project
              </Link>
              <Link
                href="#"
                className="w-40 gap-1 rounded-full border border-transparent bg-neutral-100 px-4 py-2 text-center text-sm text-black dark:bg-white font-[var(--font-sans)] transition-all hover:bg-neutral-200"
              >
                View Our Work
              </Link>
            </div>
      ...
      <div className="hidden items-center gap-6 rounded-full border border-neutral-100 bg-neutral-100 px-4 py-3 lg:flex dark:border-neutral-800 dark:bg-neutral-900">
        {links.map((link, idx) => (
          <Link
            key={link.href + idx}
            href={link.href}
            className="text-sm font-medium text-neutral-700 transition duration-200 hover:opacity-80 dark:text-neutral-200 font-[var(--font-sans)]"
          >
            {link.label}
          </Link>
        ))}
